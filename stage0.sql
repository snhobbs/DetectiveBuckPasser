...
insert into rooms values(0,1,'Bathroom', '0,1,2,3,4', NULL, "You shuffle to the corner of the room. Technically its a bathroom, minus the bath... and the room. It's just a flowery plush arm chair with the seat cut out strategically placed over a empty can of Beefarino. There's a stack of Better Homes and Gardens magazines next to the can, what mess.", 0,NULL);
...
insert into rooms values(0,3,'Window', '0,1,2,3,4', NULL, "As you survey your neighborhood you realise it's the same as always. A sickening red glow from the Hustler sign douses the streets which are littered with emaciated alley cats drawn to the cannery. A hooker is eating a tire.", 0,NULL);
