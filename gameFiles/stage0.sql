...
/**objects**/
insert into objects values(0,0, 'Couch', 'It looks like it used to be suade before the layers of hair grease and cheap whiskey have left it in a state reminiscent of your soul.', 'Your shitty beige couch','sit', "Plop your lazy self down on this gross sofa", "As you throw yourself gracelessly onto the greasy sofa what looks like a cockroach exodus complete with a cockroach Moses leading his people out of the sofa through the parting of the couch cushions begins. You have a quick nap in your natural habitat.",200);

insert into objects values(0,1, 'Toilet', "It's just a flowery plush arm chair with the seat cut out strategically placed over an empty can of Beefarino", "I guess it's a toilet", "flush", "Flush the toilet","You heave the can of beefarino out the window, no one notices, not even the alley cats or the hooker eating a tire",201);

insert into objects values(0,2, 'Magazine', "Dog eared copy of Better Homes and Gardens, the June, 1964 edition", "Better Homes and Gardens June, 1964", "read", "Flip through the magazine","You read the magazine as you have 700 times before. Maybe one day you'll try and make some of these improvements, but there you are with a can as your toilet.",202);
